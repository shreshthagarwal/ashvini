  ...
  return (
    <div className="upload-screen">
      ...
      <p className="notifications">
        New Notifications/Alerts: • Batch #A12 awaiting test results • Certificates
        for batch #B05 rejected • 3 new batches assigned to you
      </p>
        ...
        <div className="left-column">
          ...
          <label className="upload-box">
            ...
            {selectedFile ? (
              ...
              <>
                <p>Click to upload Test Result photos or drag & drop</p>
          ...
          <div className="lab-info">
            ...
            <p>
              <strong>TEST RESULT: PASS</strong>
            </p>
            <label>
              <input type="checkbox" /> I confirm that the above results are
              authentic and verified by Green Leaf Testing.
            </label>
            <button
              onClick={() => alert("Results recorded to blockchain")}
            >
        ...
        <div className="right-column">
          <div className="batch-details">
            ...
            <p>
              Location:{" "}
              {location ||
                `Latitude ${batchData.latitude} | Longitude ${batchData.longitude}`}
            </p>
          </div>
        </div>
      </div>
